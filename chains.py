...
1. net core 8 and above 
2. should follow Jason Tylor's clean architecture with Mediator pattern with CQRS (Command and Query Responsibility Segregation) pattern https://www.nuget.org/packages/Clean.Architecture.Solution.Template#readme-body-tab
3. Mongodb with default mongo driver 
4. API endpoint using fast endpoints - https://fast-endpoints.com/
